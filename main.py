...
if __name__ == "__main__":
    ...
    parser.add_argument('--modes', type=str, default='Train', help='pretrain or train or test')
    parser.add_argument('--path', type=str, default='')
    parser.add_argument('--epoch', type=int, default=50, help='epoch to train')
    parser.add_argument('--dim_en', type=int, default=64, help='dimension in encoder')
    ...
    parser.add_argument('--slices', type=int, default=5, help='split_slices')
    ...
    parser.add_argument('--weight_decay', type=float, default=0.0001, help='length of patch')
    ...
    if mode == "train":
        ...
        if PATH:
            ...
            print("Warning: No path provided for testing model. Running with random weights.")
        ...
        try:
            ...
            print("Saving results to csv instead.")
